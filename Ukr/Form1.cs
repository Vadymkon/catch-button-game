...
namespace Убегайка
{
    public partial class Втiкайка : Form
    {
        int speed = 10, smth = 1;
       ...
       // System.Drawing.Color[] arr = { "red","white" ,"blue", "yellow", "control"};
        ...
        void button1_Click(object sender, EventArgs e)
        {
            ...
            button1.Text = "Вітаємо! Ви виграли!";
            label1.Text = "Вау! Ви молодець, це було непросто!\nЩоб спробувати знову, спіймайте цей текст.";
            label1.Left = Left / 2; label1.Top = Top / 2;
            Thread.Sleep(1000);
            this.label1.MouseMove += new System.Windows.Forms.MouseEventHandler(this.label1_MouseMove);
            this.label1.Click += new System.EventHandler(this.label1_Click);
            label2.Text = "ПЕРЕЗАВАНТАЖИТИ\n(також швидкість зменшує)";
        ...
        void label1_Click(object sender, EventArgs e)
        {
            ...
            button1.Text = "TAKEME";
            label1.Left = Left / 2; label1.Top = Top / 2;
            label1.Text = "Натиснувши на текст ви зробите режим складнішим.\nАле його зловити ще потрібно))0)";
           
            WMPLib.WindowsMediaPlayer wplayer = new WMPLib.WindowsMediaPlayer();
            wplayer.URL = @"mp3\labelchange.mp3";
            wplayer.controls.play();
            
            checkBox1.Text = "Кнопка зменшена на 3 пікселі.";
